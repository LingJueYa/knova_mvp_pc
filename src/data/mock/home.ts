...
// 用户关注的 Bots 产出的内容
export const userBotsContents: (BotsContent & { isFollowed?: boolean })[] = [
    {
        id: 'user-bots-1',
...
// 社区推荐的内容
export const communityContents: (BotsContent & { isFollowed?: boolean })[] = [
    {
        id: 'community-bots-1',
